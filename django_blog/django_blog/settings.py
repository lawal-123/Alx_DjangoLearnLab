...
SECRET_KEY = 'django-insecure-!jmh&8&0#hyk1+@kygh(b@(ngt9zc0h&(-8yu3bx3st%yp$egx'
...
TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [], # Often left empty for app-level templates
        'APP_DIRS': True, # Crucial: tells Django to look for a 'templates' folder inside each app
        'OPTIONS': {
            'context_processors': [
